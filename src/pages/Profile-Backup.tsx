          ...
          <div className="py-16 text-center">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <div className="relative inline-block cursor-pointer group mb-8">
                  <Avatar className="h-32 w-32 border border-gray-200 shadow-sm group-hover:shadow-lg transition-all duration-300">
                        <AvatarImage
                          src={avatarUrl}
                          alt={user?.username}
                        ...
                        />
                    <AvatarFallback className="text-3xl font-light bg-gray-50 text-gray-700">
                      {user?.username?.[0]?.toUpperCase() || "U"}
                    </AvatarFallback>
                  </Avatar>
                  <div className="absolute inset-0 rounded-full bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
